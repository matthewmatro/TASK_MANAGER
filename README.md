...
Contributions are welcome. Open issues or pull requests for bugs and small improvements. Keep changes focused and include tests where applicable.

License

This repository does not include an explicit license file. Add one (for example `LICENSE` with an MIT license) if you want to define reuse terms.
